...
# CORS middleware - Fixed for network access
# Note: Cannot use allow_origins=["*"] with allow_credentials=True
# Either disable credentials or specify exact origins
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],  # Allow all origins
    allow_credentials=False,  # Disabled to work with wildcard origins
    allow_methods=["*"],
    allow_headers=["*"],
)
...
async def ai_config_page():
    ...
    return serve_html_file("ai_config.html", "AI Config UI not found")
